...
function sendEmail(userId, email, token) {
    ...
    const message = {
        to: email,
        from: 'Do Not Reply <admin@abcsupermarket.com.sg>',
        subject: 'Verify Abc Supermarket Account',
        text: 'and easy to do anywhere, even with Node.js',
        html: `Thank you registering with Abc Supermarket.<br><br>
...
router.post('/login', (req, res, next) => {
    ...
    User.findOne({
        ...
        passport.authenticate('local', {
            successRedirect: '/cart', // Route to /cart/listCart URL
